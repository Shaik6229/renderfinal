...
SYMBOLS = [ 
    "BTCUSDT", "ETHUSDT", "BNBUSDT", "SOLUSDT", "ADAUSDT", "XRPUSDT", "AVAXUSDT", "DOTUSDT", "MATICUSDT", "NEARUSDT",
    "TRXUSDT", "ATOMUSDT", "LTCUSDT", "LINKUSDT", "BCHUSDT", "EGLDUSDT", "XLMUSDT", "FILUSDT", "APTUSDT", "OPUSDT",
    "ARBUSDT", "INJUSDT", "FETUSDT", "RNDRUSDT", "ARUSDT", "GRTUSDT", "LDOUSDT", "STXUSDT", "CVCUSDT", "CTSIUSDT",
    "BANDUSDT", "CFXUSDT", "ZILUSDT", "SKLUSDT", "KAVAUSDT", "ANKRUSDT", "ENSUSDT", "FLUXUSDT", "SFPUSDT", "ILVUSDT",
    "AGIXUSDT", "OCEANUSDT", "DYDXUSDT", "MKRUSDT", "COTIUSDT", "REQUSDT", "PENDLEUSDT", "ACHUSDT", "LOOMUSDT", 
    "LINAUSDT", "NMRUSDT", "IDUSDT", "DOGEUSDT"
]

intervals = {"1h": 0.25, "1d": 0.35}  # TSL by timeframe
        ...
        for symbol in SYMBOLS:
            ...
            for interval, tsl_percent in intervals.items():
                try:
                    ...
                    vol = volume_spike(df)
                    trend = check_trend(symbol, "1h" if interval == "1h" else "4h" if interval == "1d" else "1w")
                    ...
                    data = {
                        ...
                        'entry': confidence >= 50, 'tp': last >= upper and k > 80 and d > 80,
                    ...
                    if data['entry'] and alert_flags.get(alert_key + "_entry") != True:
