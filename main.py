...
async def scan_symbols():
    pairs = [
    "BTCUSDT", "ETHUSDT", "BNBUSDT", "SOLUSDT", "XRPUSDT", "AVAXUSDT", "DOTUSDT", "MATICUSDT", "NEARUSDT", "ATOMUSDT",
    "LTCUSDT", "LINKUSDT", "EGLDUSDT", "XLMUSDT", "FILUSDT", "APTUSDT", "OPUSDT", "ARBUSDT", "INJUSDT", "FETUSDT",
    "RNDRUSDT", "ARUSDT", "GRTUSDT", "STXUSDT", "CVCUSDT", "CTSIUSDT", "BANDUSDT", "CFXUSDT", "KAVAUSDT", "ENSUSDT",
    "FLUXUSDT", "SFPUSDT", "ILVUSDT", "AGIXUSDT", "OCEANUSDT", "DYDXUSDT", "MKRUSDT", "IDUSDT", "TAOUSDT", "ADAUSDT",
    "TRXUSDT", "ALGOUSDT", "XTZUSDT", "ICPUSDT", "ICXUSDT", "CKBUSDT", "DIAUSDT", "UNFIUSDT", "AAVEUSDT", "GALAUSDT",
    "1INCHUSDT", "SANDUSDT", "MANAUSDT", "ROSEUSDT", "QNTUSDT", "VETUSDT", "XEMUSDT", "EOSUSDT", "ZILUSDT", "CELOUSDT",
