...
pairs = [
    ...
    "ENSUSDT", "ETHUSDT", "FETUSDT", "FILUSDT", "FLUXUSDT", "GALAUSDT", "GLMRUSDT", "GRTUSDT",
    "HOTUSDT", "ICPUSDT", "ICXUSDT", "IDUSDT", "ILVUSDT", "INJUSDT", "JOEUSDT", "KAVAUSDT", "LINKUSDT", "LPTUSDT", "LTCUSDT", "MANAUSDT", "MATICUSDT", "MIOTAUSDT", "MKRUSDT", "NEARUSDT", "OCEANUSDT",
    ...
    "XLMUSDT", "XRPUSDT", "XTZUSDT", "YGGUSDT", "ZILUSDT", "SAHARAUSDT", "NEWTUSDT",
    ]
