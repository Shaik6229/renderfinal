...
async def scan_symbols():
    ...
    "FILUSDT", "APTUSDT", "RNDRUSDT", "INJUSDT", "ARBUSDT",
    "SUIUSDT", "OPUSDT", "SEIUSDT", "TIAUSDT", "PEPEUSDT",
    "TRXUSDT", "JASMYUSDT", "COTIUSDT", "AGIXUSDT", "FETUSDT",
    "OCEANUSDT", "DUSKUSDT", "HIGHUSDT", "CTSIUSDT", "HOOKUSDT",
    "ILVUSDT", "CVCUSDT", "ONEUSDT", "BELUSDT", "ACHUSDT"
]
